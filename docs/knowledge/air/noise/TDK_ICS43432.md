...
The INVENSENSE (now TDK) [ICS43432](https://www.invensense.com/products/digital/ics-43432/) is a tiny digital MEMs microphone with I2S output.
...
![](/assets/images/ics43432-block-diagram.png)
...
![](/assets/images/ics43432-i2s-protocol.png)
...
### Converting pressure to sound level
...
![](/assets/images/ics43432-sinusoid-t.png)
...
![](/assets/images/ics43432-sinusoid-noise.png)
...
![Discrete sampling](/assets/images/ics43432-discrete-sampling.png)
...
![](/assets/images/ics43432-windowing.png)
...
![](/assets/images/ics43432-windowing-2.png)
...
![](/assets/images/ics43432-windowing-3.png)
...
![](/assets/images/ics43432-t-fft.png)
...
![](/assets/images/ics43432-filter.png)
...
The microphone was calibrated in an anechoic chamber with a reference microphone to obtain sensor equalisation. The ICS43432 has a clear non-linear response, which is specified in it's datasheet and is characterised in an anechoic chamber:

![](/assets/images/ics43432-non-linear-response.jpg)

_Image credit: [Invensense ICS43432](https://www.invensense.com/products/digital/ics-43432)_

### Test setup

**SCK side**: 1 x microphone installed in Arduino Zero (alternating Invensense and Knowles), at h = 1,2m
...
![](/assets/images/ics43432-spectrum-response.png)
...
![](/assets/images/ics43432-double-point-test.png)
...
![](/assets/images/ics43432-tolerances.png)
...
1. The microphone is not isolated in any way from humidity, dust or particles. These can affect the readings and provoke clipping in the readings (absurdly high readings). This can be improved with [additional protection](https://forum.smartcitizen.me/t/exploring-options-to-protect-the-microphone/1888) from the [datasheet](https://invensense.tdk.com/download-pdf/an-1124-recommendations-for-sealing-invensense-bottom-port-mems-microphones-from-dust-and-liquid-ingress/)
  ![](https://forum.smartcitizen.me/uploads/default/original/1X/04ae13afa0b6cb54449befe35b9555351f7979f8.png)
...
- [Library for I2S microphones](https://github.com/fablabbcn/smartcitizen-kit-audio/)
- [Noise and DSP calculations](/assets/notes/noise-dsp.pdf): a description of the math behind the noise calculations in the SCK.
- [Noise sampling](/assets/notes/noise-sampling.pdf): an evaluation of how significant sampling every 1' is with 23ms of data, versus other approaches.
