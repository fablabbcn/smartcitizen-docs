...
1. [Set up a development environment](/guides/data/advanced-data-tools/#development-instructions-advanced) and following the example on [data processing](https://github.com/fablabbcn/smartcitizen-data/tree/master/examples)
