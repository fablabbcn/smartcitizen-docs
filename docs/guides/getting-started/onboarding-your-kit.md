...
After this, make sure that the SCK is in [Setup Mode](/hardware/kit/features/#setup-mode) (LED is red) and **connect with your smartphone** to the `SmartCitizen[...]` network.
